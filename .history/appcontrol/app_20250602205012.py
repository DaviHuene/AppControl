...
class App(tk.Tk):
    ...
    def _criar_aba_pedidos(self):
        ...
        self.combo_tipo.grid(row=0, column=1, pady=5, sticky="ew")z
        ...
        self.combo_produto.grid(row=1, column=1, pady=5, sticky="ew")

        ttk.Label(frame, text="Quantidade:").grid(row=2, column=0, sticky="w", pady=5)
        self.entry_pedido_qtd = ttk.Entry(frame, width=30)
        self.entry_pedido_qtd.grid(row=2, column=1, pady=5, sticky="ew")
        ...
        # Lista de pedidos
        cols = [("ID", 50), ("Data", 140), ("Tipo", 80), ("Produto", 200), 
